...
using System.Text;
using ToDo_Core.Manager;
using ToDo_Core.Manager.Interface;
using ToDo_Core.Mapper;
using ToDo_MainProject.Extenstions;
using ToDo_MainProject.Model;

namespace ToDo_MainProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DB_ToDoContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ToDo_MainProject", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ToDo_MainProject v1"));
            }
